<template>
	<nav class="w-full flex flex-col z-20 sticky top-0 dark:shadow-white/10 shadow-sm">
		<ContentsTopNav />
		<div
			class="w-full flex flex-col px-4 md:px-8 lg:px-20 2xl:px-44 pt-2.5 md:pt-3 pb-2.5 md:pb-0 backdrop-blur-[100px] bg-c-base/80 dark:bg-c-dark/90"
		>
			...
			<div class="w-full hidden md:block mt-3 sm:mt-4 border-t border-neutral-200/60 dark:border-neutral-600">
